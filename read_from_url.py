...
def condense_annotations(file_path: str) -> dict:
    ...
    annotations: dict = {} # NOTE: id: (image_url, [(bounding_box, category_id, (category, supercategory)),])

    for image_info in raw_data["images"]: 
        annotations[image_info["id"]] = (image_info["flickr_url"], list())
...
ANNOTATIONS: dict = condense_annotations("TACO-data/annotations.json")
